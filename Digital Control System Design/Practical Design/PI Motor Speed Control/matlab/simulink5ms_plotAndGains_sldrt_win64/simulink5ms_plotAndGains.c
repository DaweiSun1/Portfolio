...
static void rate_monotonic_scheduler(void)
{
  ...
  simulink5ms_plotAndGains_M->Timing.RateInteraction.TID0_1 =
    (simulink5ms_plotAndGains_M->Timing.TaskCounters.TID[1] == 0);

  /* update PerTaskSampleHits matrix for non-inline sfcn */
  simulink5ms_plotAndGains_M->Timing.perTaskSampleHits[1] =
    simulink5ms_plotAndGains_M->Timing.RateInteraction.TID0_1;
...
void simulink5ms_plotAndGains_output0(void) /* Sample time: [0.001s, 0.0s] */
{
  ...
  if (simulink5ms_plotAndGains_M->Timing.RateInteraction.TID0_1) {
    /* RateTransition: '<Root>/Rate Transition' */
   ...
   *  Rounding: '<Root>/Round'
   */
  simulink5ms_plotAndGains_DW.DiscreteTransferFcn3_tmp = (rt_roundd_snf
    ...
    simulink5ms_plotAndGains_P.DiscreteTransferFcn3_DenCoef[1] *
    simulink5ms_plotAndGains_DW.DiscreteTransferFcn3_states) /
    simulink5ms_plotAndGains_P.DiscreteTransferFcn3_DenCoef[0];
  rtb_DiscreteTransferFcn3 =
    simulink5ms_plotAndGains_P.DiscreteTransferFcn3_NumCoef[0] *
    simulink5ms_plotAndGains_DW.DiscreteTransferFcn3_tmp +
    simulink5ms_plotAndGains_P.DiscreteTransferFcn3_NumCoef[1] *
    simulink5ms_plotAndGains_DW.DiscreteTransferFcn3_states;

  /* Sum: '<Root>/Sum' */
  Gain14 = simulink5ms_plotAndGains_B.RateTransition - rtb_DiscreteTransferFcn3;

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn' */
  simulink5ms_plotAndGains_DW.DiscreteTransferFcn_tmp = (Gain14 -
    simulink5ms_plotAndGains_P.DiscreteTransferFcn_DenCoef[1] *
    simulink5ms_plotAndGains_DW.DiscreteTransferFcn_states) /
    simulink5ms_plotAndGains_P.DiscreteTransferFcn_DenCoef[0];
   ...
   *  Gain: '<Root>/Gain12'
   */
  Gain14 = (simulink5ms_plotAndGains_P.DiscreteTransferFcn_NumCoef[0] *
            simulink5ms_plotAndGains_DW.DiscreteTransferFcn_tmp +
            simulink5ms_plotAndGains_P.DiscreteTransferFcn_NumCoef[1] *
            simulink5ms_plotAndGains_DW.DiscreteTransferFcn_states) *
    simulink5ms_plotAndGains_P.Gain_Gain +
    simulink5ms_plotAndGains_P.Gain12_Gain * Gain14;

  /* Saturate: '<Root>/Saturation' */
  if (Gain14 > simulink5ms_plotAndGains_P.Saturation_UpperSat) {
    /* Saturate: '<Root>/Saturation' */
    simulink5ms_plotAndGains_B.Saturation =
      simulink5ms_plotAndGains_P.Saturation_UpperSat;
  } else if (Gain14 < simulink5ms_plotAndGains_P.Saturation_LowerSat) {
    /* Saturate: '<Root>/Saturation' */
    simulink5ms_plotAndGains_B.Saturation =
      simulink5ms_plotAndGains_P.Saturation_LowerSat;
  } else {
    /* Saturate: '<Root>/Saturation' */
    simulink5ms_plotAndGains_B.Saturation = Gain14;
  }

  /* End of Saturate: '<Root>/Saturation' */

  /* Outport: '<Root>/Out1' */
  simulink5ms_plotAndGains_Y.Out1 = simulink5ms_plotAndGains_B.Saturation;

  /* Outport: '<Root>/Out2' */
  simulink5ms_plotAndGains_Y.Out2 = rtb_DiscreteTransferFcn3;
...
void simulink5ms_plotAndGains_update0(void) /* Sample time: [0.001s, 0.0s] */
{
  ...
  simulink5ms_plotAndGains_DW.DiscreteTransferFcn2_states =
    (simulink5ms_plotAndGains_B.DiscreteTransferFcn1 -
     simulink5ms_plotAndGains_P.DiscreteTransferFcn2_DenCoef[1] *
     simulink5ms_plotAndGains_DW.DiscreteTransferFcn2_states) /
    simulink5ms_plotAndGains_P.DiscreteTransferFcn2_DenCoef[0];
  ...
  simulink5ms_plotAndGains_DW.DiscreteTransferFcn1_states =
    (simulink5ms_plotAndGains_B.Saturation -
     simulink5ms_plotAndGains_P.DiscreteTransferFcn1_DenCoef[1] *
     simulink5ms_plotAndGains_DW.DiscreteTransferFcn1_states) /
    simulink5ms_plotAndGains_P.DiscreteTransferFcn1_DenCoef[0];
    ...
    if (tid == 1) {
      {
        ...
        sendToAsyncQueueTgtAppSvc(20563333U, time, pData, size);
      }
    }
  }
    ...
    if (tid == 1) {
      {
        ...
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(897897291U, time, pData, size);
      }
    }
  }
    ...
    if (tid == 1) {
      {
        ...
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(2901712724U, time, pData, size);
      }
    }
  }
    ...
    if (tid == 1) {
      {
        ...
        int32_T size = 1*sizeof(real_T);
        sendToAsyncQueueTgtAppSvc(4044880076U, time, pData, size);
      }
    }
  }
...
RT_MODEL_simulink5ms_plotAndGains_T *simulink5ms_plotAndGains(void)
{
  ...
  /* External mode info */
  simulink5ms_plotAndGains_M->Sizes.checksums[0] = (3886324679U);
  simulink5ms_plotAndGains_M->Sizes.checksums[1] = (3302392269U);
  simulink5ms_plotAndGains_M->Sizes.checksums[2] = (780184084U);
  simulink5ms_plotAndGains_M->Sizes.checksums[3] = (3018656040U);
  ...
  simulink5ms_plotAndGains_M->Sizes.numY = (6);/* Number of model outputs */
  ...
  simulink5ms_plotAndGains_M->Sizes.numBlocks = (62);/* Number of blocks */
  simulink5ms_plotAndGains_M->Sizes.numBlockIO = (20);/* Number of block outputs */
  simulink5ms_plotAndGains_M->Sizes.numBlockPrms = (61);/* Sum of parameter "widths" */
