...
__interrupt void cpu_timer2_isr(void)
{
    ...
    thetak = readEnc1();
    omega = 400.0*(thetak-thetak_1) + 0.6*omega1;
    e = r-thetak;
    edot = 400*(e-e1)+0.6*edot1;
    ik = ik1 +  0.0005*(e+e1);
    u = kp*e - kd*omega + ki*ik;
